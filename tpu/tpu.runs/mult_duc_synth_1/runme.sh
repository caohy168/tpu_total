...
HD_PWD='C:/Users/dell/Desktop/TPU_pr/tpu_fs/tpu.runs/mult_duc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_duc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_duc.tcl
