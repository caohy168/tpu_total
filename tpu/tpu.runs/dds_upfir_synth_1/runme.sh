...
HD_PWD='C:/Users/dell/Desktop/TPU_pr/tpu/tpu.runs/dds_upfir_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_upfir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_upfir.tcl
