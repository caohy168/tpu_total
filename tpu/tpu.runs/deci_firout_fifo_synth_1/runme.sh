...
HD_PWD='C:/Users/dell/Desktop/TPU_pr/tpu_fs/tpu.runs/deci_firout_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log deci_firout_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source deci_firout_fifo.tcl
