...
HD_PWD='C:/Users/dell/Desktop/TPU_pr/tpu_fs/tpu.runs/fir_compiler_r_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_compiler_r.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_compiler_r.tcl
