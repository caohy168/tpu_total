...
HD_PWD='C:/Users/dell/Desktop/TPU_pr/tpu_fs/tpu.runs/fir_out_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_out_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_out_fifo.tcl
