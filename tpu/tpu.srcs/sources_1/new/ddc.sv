...
logic signed[15:0]ram_sin_cnt=1;
...
ddc_out_fifo ddc_out_fifo_I (
  ...
  .s_axis_aclk(aclk),
  .s_axis_tvalid(s_axis_data_tvalid_I4),
  .s_axis_tready(s_axis_data_tready_I),
  .s_axis_tdata(cos_add_result8),
  .s_axis_tlast(s_axis_data_tlast_I4),
...
ddc_out_fifo ddc_out_fifo_Q (
  .s_axis_aresetn(!reset),
  .s_axis_aclk(aclk),
  .s_axis_tvalid(s_axis_data_tvalid_Q4),
  .s_axis_tready(s_axis_data_tready_Q),
  .s_axis_tdata(sin_sub_result8),
  .s_axis_tlast(s_axis_data_tlast_Q4),
