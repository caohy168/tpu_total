...
#
# Generated by Vivado on Thu Nov 12 02:24:14 PST 2020
...
simulate()
{
  xsim mult_duc -key {Behavioral:sim_1:Functional:mult_duc} -tclbatch cmd.tcl -protoinst "protoinst_files/mac_phy.protoinst" -log simulate.log
}
