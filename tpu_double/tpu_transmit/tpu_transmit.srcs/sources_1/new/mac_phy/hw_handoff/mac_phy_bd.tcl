...
proc create_hier_cell_mac_phy_ch0 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_mac_phy_ch0() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net mac_phy_ch0_m_axis_rx [get_bd_intf_ports m_axis_rx_0] [get_bd_intf_pins mac_phy_ch0/m_axis_rx]
  connect_bd_intf_net -intf_net mac_phy_ch0_rx_statistics [get_bd_intf_ports rx_statistics_ch0] [get_bd_intf_pins mac_phy_ch0/rx_statistics]
  connect_bd_intf_net -intf_net mac_phy_ch0_tx_statistics [get_bd_intf_ports tx_statistics_ch0] [get_bd_intf_pins mac_phy_ch0/tx_statistics]
  ...
  connect_bd_net -net [get_bd_nets mac_phy_ch0_core_clk156_out] [get_bd_ports core_clk156_out] [get_bd_pins mac_phy_ch0/clk156] [get_bd_pins mac_phy_ch0/core_clk156_out]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports mb_clk] [get_bd_pins mac_phy_ch0/s_axi_aclk]
  connect_bd_net -net prtad_1 [get_bd_ports prtad_ch0] [get_bd_pins mac_phy_ch0/prtad]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins mac_phy_ch0/areset]
  connect_bd_net -net reset_n_mac_1 [get_bd_ports reset_n] [get_bd_pins mac_phy_ch0/rx_axis_aresetn]
  connect_bd_net -net rst_clk_156_156M_peripheral_aresetn [get_bd_ports aux_resetn] [get_bd_ports s_axi_aresetn] [get_bd_pins mac_phy_ch0/s_axi_aresetn]
  ...
  connect_bd_net -net s_axis_pause_tdata_1 [get_bd_pins mac_phy_ch0/tx_ifg_delay] [get_bd_pins xlconstant_8b0/dout]
  connect_bd_net -net s_axis_pause_tvalid_1 [get_bd_pins mac_phy_ch0/tx_fault] [get_bd_pins xlconstant_1b0/dout]
  ...
  connect_bd_net -net xlconstant_0_const [get_bd_pins mac_phy_ch0/rx_dcm_locked] [get_bd_pins xlconstant_1b1/dout]
