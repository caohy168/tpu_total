...
HD_PWD='/home/caohy/tpu_kcu105/tpu.runs/mult_ddc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_ddc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_ddc.tcl
