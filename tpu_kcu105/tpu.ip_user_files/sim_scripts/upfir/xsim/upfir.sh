...
#
# Generated by Vivado on Fri Mar 20 10:42:38 +0800 2020
# SW Build 2708876 on Wed Nov  6 21:40:23 MST 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: upfir.sh [-help]
# usage: upfir.sh [-lib_map_path]
# usage: upfir.sh [-noclean_files]
# usage: upfir.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "upfir.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L fir_compiler_v7_2_13 -L xil_defaultlib -L secureip -L xpm --snapshot upfir xil_defaultlib.upfir -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim upfir -key {Behavioral:sim_1:Functional:upfir} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./upfir.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb upfir.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./upfir.sh -help\" for more information)\n"
    exit 1
  fi
