...
HD_PWD='D:/kcu105_10gbaser_trd/hardware/vivado/runs/impl_run/10gbaser_trd.runs/bb_interface_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bb_interface_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bb_interface_fifo.tcl
