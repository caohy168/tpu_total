...
// Command     : write_verilog -force -mode synth_stub -rename_top mac_phy_ten_gig_eth_pcs_pma_ch1_0 -prefix
//               mac_phy_ten_gig_eth_pcs_pma_ch1_0_ mac_phy_ten_gig_eth_pcs_pma_ch1_0_stub.v
...
module mac_phy_ten_gig_eth_pcs_pma_ch1_0(dclk, rxrecclk_out, coreclk, txusrclk, txusrclk2, 
  ...
  xgmii_txd, xgmii_txc, xgmii_rxd, xgmii_rxc, txp, txn, rxp, rxn, mdc, mdio_in, mdio_out, mdio_tri, prtad, 
  core_status, tx_resetdone, rx_resetdone, signal_detect, tx_fault, drp_req, drp_gnt, 
  core_to_gt_drpen, core_to_gt_drpwe, core_to_gt_drpaddr, core_to_gt_drpdi, gt_drprdy, 
  gt_drpdo, gt_drpen, gt_drpwe, gt_drpaddr, gt_drpdi, core_to_gt_drprdy, core_to_gt_drpdo, 
  pma_pmd_type, tx_disable)
