...
HD_PWD='D:/project/ethnet/kcu105_10gbaser_trd/hardware/vivado/runs/impl_run/10gbaser_trd.runs/ila_interface_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_interface.tcl
