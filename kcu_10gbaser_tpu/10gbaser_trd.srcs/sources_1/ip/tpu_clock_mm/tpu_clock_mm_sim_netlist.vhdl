...
--               C:/Users/dell/Desktop/board_test/kcu_10gbaser_tpu/10gbaser_trd.srcs/sources_1/ip/tpu_clock_mm/tpu_clock_mm_sim_netlist.vhdl
-- Design      : tpu_clock_mm
...
entity tpu_clock_mm_tpu_clock_mm_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of tpu_clock_mm_tpu_clock_mm_clk_wiz : entity is "tpu_clock_mm_clk_wiz";
end tpu_clock_mm_tpu_clock_mm_clk_wiz;

architecture STRUCTURE of tpu_clock_mm_tpu_clock_mm_clk_wiz is
  signal clk_in1_tpu_clock_mm : STD_LOGIC;
  signal clk_out1_tpu_clock_mm : STD_LOGIC;
  signal clk_out2_tpu_clock_mm : STD_LOGIC;
  signal clkfbout_buf_tpu_clock_mm : STD_LOGIC;
  signal clkfbout_tpu_clock_mm : STD_LOGIC;
...
entity tpu_clock_mm is
  ...
  attribute NotValidForBitStream of tpu_clock_mm : entity is true;
end tpu_clock_mm;

architecture STRUCTURE of tpu_clock_mm is
begin
inst: entity work.tpu_clock_mm_tpu_clock_mm_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
