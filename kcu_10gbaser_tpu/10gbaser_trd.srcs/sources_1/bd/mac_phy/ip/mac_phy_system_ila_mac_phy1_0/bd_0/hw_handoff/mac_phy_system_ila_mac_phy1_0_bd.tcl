...
################################################################
# This is a generated script based on design: bd_0423
#
...
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_ports SLOT_3_AXIS] [get_bd_intf_pins g_inst/slot_3_axis]
  ...
  connect_bd_net -net net_slot_2_axis_tkeep [get_bd_pins g_inst/m_slot_2_axis_tkeep] [get_bd_pins ila_lib/probe12]
  ...
  connect_bd_net -net net_slot_2_axis_tuser [get_bd_pins g_inst/m_slot_2_axis_tuser] [get_bd_pins ila_lib/probe13]
  ...
  connect_bd_net -net net_slot_3_axis_tkeep [get_bd_pins g_inst/m_slot_3_axis_tkeep] [get_bd_pins ila_lib/probe18]
  connect_bd_net -net net_slot_3_axis_tlast [get_bd_pins g_inst/m_slot_3_axis_tlast] [get_bd_pins ila_lib/probe21]
  connect_bd_net -net net_slot_3_axis_tuser [get_bd_pins g_inst/m_slot_3_axis_tuser] [get_bd_pins ila_lib/probe19]
