...
#
# Generated by Vivado on Sun May 31 19:38:46 PDT 2020
...
# Script info
echo -e "rs_decoder.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
simulate()
{
  xsim rs_decoder -key {Behavioral:sim_1:Functional:rs_decoder} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0423.protoinst" -protoinst "protoinst_files/mac_phy.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6)
