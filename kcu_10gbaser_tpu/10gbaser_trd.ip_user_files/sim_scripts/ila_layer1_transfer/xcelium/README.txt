...
#
# Generated by export_simulation on Thu Jun 11 16:56:14 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ila_layer1_transfer.sh' script.

./ila_layer1_transfer.sh -reset_run
...
./ila_layer1_transfer.sh -noclean_files

For more information on the script, please type './ila_layer1_transfer.sh -help'.
