...
#
# Generated by export_simulation on Thu Jun 18 13:49:36 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ila_layer1_receive.sh' script.

./ila_layer1_receive.sh -reset_run
...
./ila_layer1_receive.sh -noclean_files

For more information on the script, please type './ila_layer1_receive.sh -help'.
