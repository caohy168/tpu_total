...
HD_PWD='C:/Users/dell/Desktop/board_test/kcu_10gbaser_tpu/10gbaser_trd.runs/tpu_clock_mm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_clock_mm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tpu_clock_mm.tcl
