...
HD_PWD='C:/Users/dell/Desktop/board_test/kcu_10gbaser_tpu/10gbaser_trd.runs/bb_data_loopback_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bb_data_loopback_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bb_data_loopback_fifo.tcl
