...
HD_PWD='C:/Users/dell/Desktop/board_test/kcu_10gbaser_tpu/10gbaser_trd.runs/ila_layer1_receive_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_layer1_receive.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_layer1_receive.tcl
