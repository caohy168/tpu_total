...
#
# Generated by export_simulation on Tue Jan 07 13:40:40 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './dds_Q.sh' script.
...
./dds_Q.sh -noclean_files

For more information on the script, please type './dds_Q.sh -help'.
