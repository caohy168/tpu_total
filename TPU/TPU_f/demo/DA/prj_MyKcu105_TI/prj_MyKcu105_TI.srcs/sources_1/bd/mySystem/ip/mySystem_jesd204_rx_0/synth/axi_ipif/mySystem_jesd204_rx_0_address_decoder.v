// 
//-----------------------------------------------------------------------------
// Filename:        mySystem_jesd204_rx_0_address_decoder.v
// Version:         v1.00.a
...
module mySystem_jesd204_rx_0_address_decoder
#(
...
if (C_NUM_ADDRESS_RANGES > 1)begin : GEN_FOR_MULTI_CS
 mySystem_jesd204_rx_0_pselect_f #(.C_AB(DECODE_BITS),
             .C_AW(C_BUS_AWIDTH),
...
//--------------------------------------------------------------------
    ...
    if (CE_ADDR_SIZE > 0) begin : MULTIPLE_CES_THIS_CS_GEN
      ...
      mySystem_jesd204_rx_0_pselect_f #(.C_AB(CE_ADDR_SIZE),
                  .C_AW(CE_ADDR_SIZE),
                  .C_BAR(BAR),
                  .C_FAMILY(C_FAMILY)
                 ) 
