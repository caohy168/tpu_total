...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.mySystem \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../prj_MyKcu105_TI.srcs/sources_1/bd/mySystem/ipshared/4fba" \
       +incdir+"../../../../prj_MyKcu105_TI.srcs/sources_1/bd/mySystem/ipshared/4fba"
}
