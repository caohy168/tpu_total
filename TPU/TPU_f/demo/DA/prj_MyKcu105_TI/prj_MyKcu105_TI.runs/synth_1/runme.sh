...
HD_PWD='D:/Soliton_work/Xilinx/DAC38RF82/UltraScale_P7_T14/prj_MyKcu105_TI/prj_MyKcu105_TI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mySystem_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mySystem_wrapper.tcl
