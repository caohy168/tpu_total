...
#
# Generated by export_simulation on Thu Apr 09 14:13:50 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './deci_firout_fifo.sh' script.

./deci_firout_fifo.sh -reset_run
...
./deci_firout_fifo.sh -noclean_files

For more information on the script, please type './deci_firout_fifo.sh -help'.
