...
#
# Generated by export_simulation on Thu Apr 09 16:29:45 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './fir_out_fifo.sh' script.

./fir_out_fifo.sh -reset_run
...
./fir_out_fifo.sh -noclean_files

For more information on the script, please type './fir_out_fifo.sh -help'.
