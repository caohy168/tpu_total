...
// Command     : write_verilog -force -mode synth_stub -rename_top axis_fifo_r -prefix
//               axis_fifo_r_ duc_out_fifo_stub.v
// Design      : duc_out_fifo
...
module axis_fifo_r(s_axis_aresetn, s_axis_aclk, s_axis_tvalid, 
